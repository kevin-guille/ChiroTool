...
def _build_readme(plan: ExportPlan, result_stats: dict) -> str:
    ...
    lines += [
        ...
        "Réutilisation",
        "-------------",
        "  Ouvrez le dossier ChiroTool_export_… (ou le dossier de campagne",
        "  qu'il contient) comme workspace ChiroTool, puis Scanner. Les",
        "  pastilles se reconstruisent depuis le disque (xlsx, Data_k,",
        "  manifest). N'ouvrez pas un sous-dossier Data_k : c'est le miroir",
        "  TE, pas la session.",
        "",

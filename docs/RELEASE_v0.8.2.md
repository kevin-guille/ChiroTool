...
> `C431B224DD3EF135F6964B8CF94A0703CDB70072E1CF45C1343281584C21130A`.
> La Latest reste
...
- **☁️ Suivi d'upload** (issue #11) : fermer la fenêtre de suivi rend les
  ...
  pour plus tard.
- **🔧 Vérifier / Réparer** (issue #14) : le statut montre l'étape
  (WAV locaux, puis page du portail) au lieu de rester sur « Préparation… ».
  « à reprendre » veut dire : participation connue, tableur absent du
  dossier. Si Data_k est là mais incomplet, la ligne dit « Data_k incomplet ».
  Tadarida n'est pas relancée si la nuit est déjà analysée.
- **📈 Activité** (issue #12) : si les taxons cochés ne sont pas dans la
  nuit affichée, le graphe le dit. La case s'appelle « Interprétation _Vu ».
  « Identifications validées seulement » a le même libellé qu'en Synthèse.

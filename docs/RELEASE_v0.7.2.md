...
Inclut le correctif d'ouverture d'un CSV dans le logiciel externe
([#7](https://github.com/kevin-guille/ChiroTool/issues/7), pre-release 0.7.1)
plus les retours de test. La validation se fait dans le logiciel externe.
...
- **Barre d'actions** : une seule ligne ; glissement vers la droite si l'écran
  est étroit (molette ou curseur). Dans **CSV nuits**, Ouvrir le CSV / 📈 / Synthèse sont sous le libellé.
